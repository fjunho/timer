...
export function Home() {
  ...
  const task = watch('task')// para observar os campos task do formulario e ele criou variavel auxiliar a issubmitedisabled
      ...
      <form onSubmit={handleSubmit(handleCreateNewCycle)} action="">
        <FormContainer>
            ...
            <MinuteAmountInput type="number" 
              ...
              min={5}
              max={60}
              {...register('minutesAmount', {valueAsNumber:true})}//valueasnumber e para o numero inteiro ser reconhecido como inteiro 
            />
